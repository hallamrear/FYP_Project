...
#define PARTICLE_COLLIDER_SIZE 5.0f
#define PARTICLE_SEARCH_DISTANCE (10.0f * PARTICLE_COLLIDER_SIZE)
#define WORLD_SIZE Vector2f(400.0f, 400.0f)
#define GRID_SIZE Vector2i(10, 10)
#define WORLD_EDGE 75.0f

//Simulation stuff
#define STARTING_PARTICLE_COUNT 0
...
//#define REST_DENSITY 16.0f
//#define VISCOSITY_CONSTANT 50.0f
 
#define GAS_CONSTANT  100.0f
